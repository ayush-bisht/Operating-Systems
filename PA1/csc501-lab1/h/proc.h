...
struct	pentry	{
	...
	int goodness;		//all processes when created will have goodness and counter intialized to 0, thus despite being in the ready queue, will not get scheduled if an epoch session is going on
	int counter;
	int quantum;
};
